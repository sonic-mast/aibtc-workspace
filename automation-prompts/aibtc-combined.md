...
5. T1 slots 1, 2, 5 are paid/accepted; 3 and 4 are open until 2026-09-25. Tier 2 timing is owned by Phase 4.6 (posts ~2026-09-26). Submissions from addresses in `postedBountyWatch.winners.tier1[]` on a T1 slot are `fail:already-won-tier1` — record them, do not ping.
