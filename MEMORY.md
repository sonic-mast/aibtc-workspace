...
- [Signal approval patterns](memory/signal-approval-patterns.md) — 21% approval rate; BFF competition updates keep leaking through; deadline+consequence formula works
