...
- [Bounty-hunting notes](memory/bounty-audit-fix-pr-infeasible.md) — Zest fix-PR #58 (open, awaiting merge); inference-provider needs real hosted infra; reading live Hiro source (not just the poster's bullet list) landed a Medium finding on the passkey-wallet stress-test bounty
