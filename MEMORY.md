...
- [Bounty audit fix-PR feasibility](memory/bounty-audit-fix-pr-infeasible.md) — mqewgyvr5063fd520a70: Bitflow + ALEX findings are dead ends (repo stale/nonexistent); Zest F-01 is live and confirmed fixable at Zest-Protocol/zest-contracts — continue there
