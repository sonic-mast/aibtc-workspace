...
- [GitHub MCP scope](memory/github-mcp-scope.md) — mcp__github__ tools restricted to sonic-mast/aibtc-workspace; use curl for all aibtcdev/agent-news and BitflowFinance comments
