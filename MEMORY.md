...
- [tags[0] must equal beat slug](memory/tags-beat-slug-position.md) — Silent v3 rule: wrong tag position = beatRelevance=0; put beat slug first in every tags array before filing
